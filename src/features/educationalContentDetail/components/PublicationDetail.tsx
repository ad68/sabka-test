                ...
                <div className="bg-white order-2 mt-10 xl:mt-0 xl:order-1 pb-10  xl:grow-[1.5] relative text-[#284D2C] rounded-[10px] p-4">
                    ...
                    {data && <h3>
                        ...
                        >
                            ...
                            <div className="h-[60px] w-[60px] absolute flex justify-center items-center left-[-5px] bg-[#02240513] rounded-full">{data.fileUrl.split(".")[3] === "pdf" ? <PdfIcon className="text-red-500 w-[25px]" /> : <File className="text-slate-500" />}</div>
