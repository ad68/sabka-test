...
export default function Index() {
    const { currentVideo, openPlayer, playVideo, setOpenPlayer, isFetching, data, total, currentPage, setCurrentPage } = useVideos()
    return <>

        <section className="w-[1140px] mb-20 h-auto relative  m-auto px-[20px] xl:px-0 rounded-xl mt-10 min-h-10 max-w-full">
            <h1 className="text-primary text-[32px] font-bold">آلبوم ویدئوها</h1>
            <ConfigProvider
                theme={{
                    token: {
                        colorPrimary: "#2ebf70",
