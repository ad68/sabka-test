...
import useAddPost from "@/features/admin/post/hook/mutations/useAddPost";
...
const useCreatePostForm = ({ reloadTable, onClose, articleType }: {
    reloadTable: () => void, onClose: () => void,
    articleType: 'REGULATION' | 'NOTICE' | 'POST' | 'PUBLICATION'
}) => {
    const { isSuccess, mutate, isPending } = useAddPost()
