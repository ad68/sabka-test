...
import useCreatePostForm from "@/features/admin/post/hook/useCreatePostForm";
...
export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending } = useCreatePostForm({ reloadTable: reloadTable, onClose: onClose, articleType: 'POST' });
