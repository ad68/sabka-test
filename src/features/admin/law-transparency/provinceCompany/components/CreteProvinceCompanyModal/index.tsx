...
import useCreateProvinceCompanyModal from "../../hook/useCreateProvinceCompanyModal";


export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending, provinces, provincesLoading } = useCreateProvinceCompanyModal({ reloadTable: reloadTable, onClose: onClose });
