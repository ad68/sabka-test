...
import useCreatePictureGalleryForm
    from "@/features/admin/media/components/picture-gallery/hook/useCreatePictureGalleryForm";

export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending } = useCreatePictureGalleryForm({ reloadTable: reloadTable, onClose: onClose });
    return (<>
        <form
