...
import useUpdateFilmPromotionalForm
    from "@/features/admin/media/components/film-promotional/hook/useUpdateFilmPromotionalForm";
...
export default function Index({ reloadTable, onClose, selectedRow }: { reloadTable: () => void, onClose: () => void, selectedRow: any }) {
    const { control, errors, onSubmit, handleSubmit, updatePending, } = useUpdateFilmPromotionalForm({
