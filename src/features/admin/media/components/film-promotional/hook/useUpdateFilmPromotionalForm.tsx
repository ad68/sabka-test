...
import useUpdateFilmPromotional
    from "@/features/admin/media/components/film-promotional/hook/mutations/useUpdateFilmPromotional";
...
const useUpdateFilmPromotionalModal = ({ reloadTable, onClose, selectedRow }: { reloadTable: () => void, onClose: () => void, selectedRow: any }) => {
    const { isSuccess: updateSuccess, error: updateError, mutate: updateImg, isPending: updatePending } = useUpdateFilmPromotional()
...
export default useUpdateFilmPromotionalModal;
