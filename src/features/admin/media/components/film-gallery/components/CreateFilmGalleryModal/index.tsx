...
import useCreateFilmGalleryForm from "@/features/admin/media/components/film-gallery/hook/useCreateFilmGalleryForm";


export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending } = useCreateFilmGalleryForm({ reloadTable: reloadTable, onClose: onClose });
