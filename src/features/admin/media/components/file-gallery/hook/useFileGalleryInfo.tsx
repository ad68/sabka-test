...
const useFileGalleryInfo = () => {
    const [isAddModalOpen, setIsAddModalOpen] = useState(false)
    const [isUpdateModalOpen, setIsUpdateModalOpen] = useState(false)
    const [reload, setReload] = useState(false)

    // const [statusFileGalleryType, setStatusFileGalleryType] = useState<string | null>(null);
    ...
    const cols: Array<col> = [
        ...
        // { title: "وضعیت", field: "statusFileGalleryType", type: "condition", conditions: [{ value: "INITIALIZE", replacedValue: "ثبت اولیه" }, { value: "PUBLISH", replacedValue: "منتشر شده" }] },
    ];
...
export default useFileGalleryInfo