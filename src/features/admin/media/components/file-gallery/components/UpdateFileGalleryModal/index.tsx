...
import useUpdateFileGalleryForm from "@/features/admin/media/components/file-gallery/hook/useUpdateFileGalleryForm";
...
export default function Index({ reloadTable, onClose, selectedRow }: { reloadTable: () => void, onClose: () => void, selectedRow: any }) {
    const { control, errors, onSubmit, handleSubmit, updatePending, } = useUpdateFileGalleryForm({ reloadTable: reloadTable, onClose: onClose, selectedRow: selectedRow })
