...
import useCreateFinancialInfoForm
    from "@/features/admin/media/components/financial-info/hook/useCreateFinancialInfoForm";

export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending } = useCreateFinancialInfoForm({ reloadTable: reloadTable, onClose: onClose });
    return (
        <form
