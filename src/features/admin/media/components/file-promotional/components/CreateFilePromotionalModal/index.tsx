...
import useCreateFilePromotionalForm
    from "@/features/admin/media/components/file-promotional/hook/useCreateFilePromotionalForm";
...
export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending } = useCreateFilePromotionalForm({ reloadTable: reloadTable, onClose: onClose });
