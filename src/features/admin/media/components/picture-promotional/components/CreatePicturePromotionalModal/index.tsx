...
import useCreatePicturePromotionalForm
    from "@/features/admin/media/components/picture-promotional/hook/useCreatePicturePromotionalForm";

export default function Index({ reloadTable, onClose }: { reloadTable: () => void, onClose: () => void }) {
    const { control, errors, handleSubmit, onSubmit, isPending } = useCreatePicturePromotionalForm({ reloadTable: reloadTable, onClose: onClose });
    return (
        <form
