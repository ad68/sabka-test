...
import useUpdateComplaintForm from "@/features/admin/complaint/hook/useUpdateComplaintForm";
...
export default function Index({ reloadTable, onClose, selectedRow }: { reloadTable: () => void, onClose: () => void, selectedRow: any }) {
    const { control, errors, onSubmit, handleSubmit, updatePending, } = useUpdateComplaintForm({ reloadTable: reloadTable, onClose: onClose, selectedRow: selectedRow })
