...
import useUpdateNotice from "@/features/admin/notice/hook/mutations/useUpdateNotice";
...
const useUpdateNoticeModal = ({ reloadTable, onClose, selectedRow, articleType }: { reloadTable: () => void, onClose: () => void, selectedRow: any, articleType: ARTICLETYPEENUM }) => {
    const { isSuccess: updateSuccess, error: updateError, mutate: updateNotice, isPending: updatePending } = useUpdateNotice()
    ...
    const onSubmit = (data: FormSchemaType) => {
        ...
        updateNotice({ data: formData, id: selectedRow?.id, })
    }
...
export default useUpdateNoticeModal;
