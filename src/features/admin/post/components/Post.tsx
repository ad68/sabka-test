...
import usePostInfo from "@/features/admin/post/hook/usePostInfo";

export default function Index() {
    const { tableConfig, tableContent, isAddModalOpen, setIsAddModalOpen, isUpdateModalOpen, setIsUpdateModalOpen, reloadTable, persianTitle, setPersianTitle, setStatusArticleType, statusArticleType, selectedRow, search, createdOn, setCreatedOn } = usePostInfo('POST')
    return <section>
        ...
        <CustomModal width={1000} open={isAddModalOpen} onClose={() => { setIsAddModalOpen(false) }} >
            <CreatePostModal reloadTable={reloadTable} onClose={() => { setIsAddModalOpen(false) }} />
        </CustomModal>
        <CustomModal width={1000} open={isUpdateModalOpen} onClose={() => { setIsUpdateModalOpen(false) }} >
            <UpdatePostModal selectedRow={selectedRow} reloadTable={reloadTable} onClose={() => { setIsUpdateModalOpen(false) }} />
        </CustomModal>
    </section>
}
